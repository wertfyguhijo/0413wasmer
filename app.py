...
# 环境变量
UUID = os.environ.get('UUID', '9ad0c21d-dc47-460c-9551-e5534870eaf1')   # 节点UUID
...
DOMAIN = os.environ.get('DOMAIN', 'qaf.hd0130nd.dpdns.org')                # 项目分配的域名或反代后的域名,不包含https://前缀,例如: domain.xxx.com
